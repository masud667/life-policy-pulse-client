    ...
    <footer className="bg-base-100  text-base-content">
      ...
      <div className="w-full overflow-hidden">
        <svg
          ...
          className="fill-current text-blue-800/20 w-full h-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center mb-4">
              <Logo />
              <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 to-teal-200 pl-2">
                LifePolicyPulse
              </span>
            </div>
            <p className="text-base-content mb-6">
              Your trusted partner for life insurance solutions. We help you
              find the perfect coverage to protect what matters most.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://facebook.com"
                className="bg-blue-700 hover:bg-blue-600 p-3 rounded-full transition-all duration-300">
                <FaFacebook className=" text-white" />
              </a>
              <a
                href="https://x.com"
                className="bg-blue-500 hover:bg-blue-400 p-3 rounded-full transition-all duration-300">
                <FaTwitter className=" text-white" />
              </a>
              <a
                href="https://instagram.com"
                className="bg-pink-600 hover:bg-pink-500 p-3 rounded-full transition-all duration-300">
                <FaInstagram className="text-white" />
              </a>
              <a
                href="https://linkedin.com"
                className="bg-blue-600 hover:bg-blue-500 p-3 rounded-full transition-all duration-300">
                <FaLinkedin className=" text-white" />
              </a>
              <a
                href="https://youtube.com"
                className="bg-red-600 hover:bg-red-500 p-3 rounded-full transition-all duration-300">
            ...
            <ul className="space-y-3">
              {links.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className=" hover: text-base-content flex items-center transition-all duration-300 group">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            {[
              ...
              <a
                key={item}
                href="#"
                className=" hover: text-base-content/50  text-sm transition-colors duration-300">
                {item}
              </a>
            ))}
          </div>
