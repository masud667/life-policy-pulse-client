...
const Sidebar = ({ role }) => {
  ...
  return (
    <>
      ...
      <button
        className="fixed top-20 left-4 z-50 lg:hidden border border-blue-600 text-base-content p-2 rounded-md shadow-lg"
            ...
            (item) =>
              item.visible && (
                <motion.li
                  ...
                  <Link
                    to={item.path}
                    className="flex items-center p-3 text-gray-200 rounded-lg hover:bg-indigo-700/80 transition-all duration-200 hover: text-base-content group">
