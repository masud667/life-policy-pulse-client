      ...
      <div className="p-5">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h3 className="text-lg font-bold text-gray-800 mt-2">{policy.title}</h3>
            <p className="text-sm text-gray-500 mt-1">Category: {policy.category}</p>
          </div>
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          <button 
            ...
            className="flex-1 bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 px-4 py-2 rounded-lg font-medium transition-colors"
          >
            View Details
          </button>
          <button 
