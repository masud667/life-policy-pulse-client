  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const claimsRes = await AuthSecureAxios.get(`/claims/user/${user?.email}`);
            ...
            {policies?.map((policy) => {
              ...
              return (
                ...
                <div className="mt-3 flex items-center justify-between">
                  ...
                  >
                    {claim.status === "Approved" ? "View Confirmation" : "View Details"}
                  </button>
                </div>
              ) : (
                <button
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="font-medium">
                  {policies.find(p => p._id === selectedClaim.policyId)?.title || "Unknown Policy"}
                </p>
              </div>
