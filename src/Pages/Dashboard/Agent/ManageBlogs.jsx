  ...
  return (
    <div className="p-4 w-11/12 mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h2 className="text-2xl font-bold  text-base-content">Manage Blogs</h2>
        <button
          onClick={() => {
            setEditData(null);
            setModal(true);
          }}
          className="bg-indigo-600 hover:bg-indigo-700  text-base-content px-4 py-2 rounded-md transition flex items-center gap-2">
      ...
      {loading ? (
        ...
        <div className="text-center py-12  bg-base-50 rounded-lg border border-gray-200">
          ...
          <button
            ...
            className="bg-indigo-600 hover:bg-indigo-700  text-base-content px-4 py-2 rounded-md flex items-center gap-2 mx-auto">
        ...
        <>
          ...
          <div className="hidden md:block overflow-x-auto rounded-lg border border-gray-200">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className=" bg-base-100 divide-y divide-gray-200">
                {blogs.map((blog) => (
                  <tr key={blog._id} className="hover: bg-base-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-3">
                        <button
                          ...
                          className="text-indigo-600 hover:text-indigo-600 flex items-center gap-1">
          ...
          <div className="md:hidden grid grid-cols-1 gap-4">
            {blogs.map((blog) => (
              <div
                key={blog._id}
                className=" bg-base-100 rounded-lg border border-gray-200 p-4 shadow-sm">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-indigo-600 hover:text-indigo-600 p-1"
                      title="Edit">
      ...
      <Dialog
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg  bg-base-100 shadow-xl">
            <div className="sticky top-0  bg-base-100 border-b p-5">
            ...
            <form onSubmit={handleSave} className="p-5 space-y-5">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-gray-200">
                <button
                  ...
                  className="px-5 py-2.5 border border-gray-300 rounded-lg hover: bg-base-50 transition">
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-indigo-600  text-base-content rounded-lg hover:bg-indigo-700 transition">
