...
import { 
  FiUser, FiMail, FiFileText, FiCheckCircle, 
  FiXCircle, FiClock, FiEye, FiChevronDown, 
  FiMapPin, FiHeart, FiCreditCard, FiRefreshCw,
  FiAlertCircle
} from "react-icons/fi";
  ...
  const fetchApplications = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:5000/agent/applications/${user.email}`
      );
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Assigned Customers</h2>
          <p className="text-gray-600 mt-1">Manage customer applications and policies</p>
        </div>
                ...
                <tr key={app._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <select 
                        value={app.status} 
                        onChange={(e) => handleStatusChange(app._id, e.target.value, app.policyId)}
            ...
            <div key={app._id} className="bg-white rounded-xl shadow-sm p-4">
              <div className="flex items-start justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-gray-900">{app.customerName}</h3>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="w-full max-w-md rounded-xl bg-white shadow-xl overflow-hidden">
            <div className="bg-indigo-600 p-5">
              <Dialog.Title className="text-xl font-bold text-white">Customer Profile</Dialog.Title>
            </div>
            ...
            {selectedApp && (
              <div className="p-5 max-h-[70vh] overflow-y-auto">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">{selectedApp.customerName}</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="font-medium">{selectedApp.nidNumber || "Not provided"}</p>
                    </div>
                  </div>
                  ...
                  {selectedApp.healthConditions?.length > 0 && (
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="font-medium">{selectedApp.healthConditions.join(", ")}</p>
                      </div>
                    </div>
                  )}
                </div>
