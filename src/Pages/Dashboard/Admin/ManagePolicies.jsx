...
const ManagePolicies = () => {
  ...
  const onSubmit = async (data) => {
    try {
      if (editingPolicy) {
        await axios.patch(`http://localhost:5000/policies/${editingPolicy._id}`, data);
        Swal.fire("Updated!", "Policy updated successfully", "success");
      } else {
        await axios.post("http://localhost:5000/policies", data);
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-5 mb-6 md:mb-8">
          <div className="bg-white rounded-lg md:rounded-xl shadow p-3 md:p-6 border-l-4 border-indigo-500">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-gray-500 text-xs md:text-sm font-medium">Total Policies</p>
                <p className="text-lg md:text-2xl font-bold mt-1">{policies?.length}</p>
              </div>
          ...
          <div className="bg-white rounded-lg md:rounded-xl shadow p-3 md:p-6 border-l-4 border-green-500">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-gray-500 text-xs md:text-sm font-medium">Health Policies</p>
          ...
          <div className="bg-white rounded-lg md:rounded-xl shadow p-3 md:p-6 border-l-4 border-blue-500">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-gray-500 text-xs md:text-sm font-medium">Life Policies</p>
                <p className="text-lg md:text-2xl font-bold mt-1">
          ...
          <div className="bg-white rounded-lg md:rounded-xl shadow p-3 md:p-6 border-l-4 border-purple-500">
            <div className="flex justify-between items-center">
              <div>
                <p className="text-gray-500 text-xs md:text-sm font-medium">Property Policies</p>
                <p className="text-lg md:text-2xl font-bold mt-1">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">ID: {policy._id.substring(0, 8)}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                          policy.category === "Health" ? "bg-green-100 text-green-800" :
          ...
          {filteredPolicies.length === 0 ? (
            ...
            <div className="space-y-4">
              {filteredPolicies.map((policy) => (
                <div key={policy._id} className="bg-white rounded-lg shadow p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{policy.minAge} - {policy.maxAge} yrs</p>
                    </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  <div>
                    ...
                    <input 
                      ...
                      className={`w-full px-4 py-2 rounded-lg border ${errors.title ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                    />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select 
                        ...
                        className={`w-full px-4 py-2 rounded-lg border ${errors.category ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                      >
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      rows="3"
                      className={`w-full px-4 py-2 rounded-lg border ${errors.description ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                    ></textarea>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full px-4 py-2 rounded-lg border ${errors.minAge ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                      />
                      {errors.minAge && <p className="mt-1 text-sm text-red-600">{errors.minAge.message}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full px-4 py-2 rounded-lg border ${errors.maxAge ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                      />
                      {errors.maxAge && <p className="mt-1 text-sm text-red-600">{errors.maxAge.message}</p>}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full px-4 py-2 rounded-lg border ${errors.coverageRange ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                      />
                      {errors.coverageRange && <p className="mt-1 text-sm text-red-600">{errors.coverageRange.message}</p>}
                    </div>
                    
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Duration Options (years)</label>
                      <input 
                        {...register("durationOptions", { required: "Duration options are required" })} 
                        placeholder="Duration Options" 
                        className={`w-full px-4 py-2 rounded-lg border ${errors.durationOptions ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                      />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Base Premium Rate ($/month)</label>
                    <input 
                      type="number" 
                      step="0.01" 
                      ...
                      className={`w-full px-4 py-2 rounded-lg border ${errors.basePremiumRate ? "border-red-500" : "border-gray-300"} focus:ring-2 focus:ring-indigo-300 focus:border-transparent`}
                    />
