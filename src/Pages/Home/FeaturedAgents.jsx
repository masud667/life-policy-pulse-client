...
import { FiStar, FiMessageSquare, FiPhone, FiMail, FiAward } from "react-icons/fi";
...
const FeaturedAgents = () => {
  ...
  useEffect(() => {
    axios.get("https://life-policy-pulse-server.vercel.app/agents/featured")
      .then(res => {
        setAgents(res.data);
        setLoading(false);
      })
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Connect with our top-performing insurance professionals dedicated to finding the perfect policy for your needs.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h4 className="text-xs uppercase tracking-wider text-gray-500 mb-1">Specialties</h4>
                ...
                <div className="flex justify-between mt-6 pt-6 border-t border-gray-100">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium px-4 py-2 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all flex items-center"
                  >
        ...
        {agents.length === 0 && !loading && (
          <div className="text-center py-12 bg-white rounded-xl shadow-sm max-w-2xl mx-auto">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">No Featured Agents Available</h3>
            <p className="text-gray-600 max-w-md mx-auto">
              Our top agents are currently helping other clients. Please check back soon!
            </p>
          </div>
        )}
