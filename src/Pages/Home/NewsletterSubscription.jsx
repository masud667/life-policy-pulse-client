  ...
  return (
    <div className="py-16  bg-base-100">
      <div className="w-11/12 mx-auto">
        <div className=" bg-base-100 rounded-3xl shadow-xl overflow-hidden border border-gray-100">
          <div className="md:flex">
            <div className="md:w-2/5 bg-gradient-to-br from-blue-600 to-purple-600 p-10  text-base-content">
              <div className="flex flex-col h-full justify-center">
                <motion.div
                  ...
                  className="mb-6">
                  <div className=" bg-base-100/20 backdrop-blur-sm rounded-xl p-4 inline-block">
                ...
                <motion.div
                  ...
                  <div className="flex items-center text-sm">
                    <div className="w-8 h-8 rounded-full  bg-base-100/20 flex items-center justify-center mr-3">
                      <FiCheck className=" text-base-content" />
                    </div>
            ...
            <div className="md:w-3/5 p-8 md:p-10">
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.1 }}
                className=" text-base-content mb-8">
              ...
              {status === "success" ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <FiMail className=" text-base-content" />
                      </div>
                      <input
                        type="email"
                        id="email"
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600  text-base-content font-medium py-3 px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg flex items-center justify-center"
                  ...
                  <p className="text-xs  text-base-content mt-4 text-center">
