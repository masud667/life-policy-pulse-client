...
const NewsletterSubscription = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://life-policy-pulse-server.vercel.app/newsletterSubscribe', formData);
      setStatus('success');
          ...
          <div className="md:flex">
            <div className="md:w-2/5 bg-gradient-to-br from-blue-600 to-purple-600 p-10 text-white">
              <div className="flex flex-col h-full justify-center">
                ...
                >
                  Subscribe to our newsletter for the latest insurance insights, tips, and exclusive offers.
                </motion.p>
