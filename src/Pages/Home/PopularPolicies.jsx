    ...
    const fetchPopularPolicies = async () => {
      try {
        const response = await axios.get(
          "https://life-policy-pulse-server.vercel.app/policies"
        );
  ...
  if (error) {
    return (
      <div className="text-center py-10">
        ...
        <button
          className="bg-gradient-to-r from-blue-600 to-purple-600  text-base-content px-4 py-2 rounded-lg hover:from-blue-700 hover:to-purple-700 transition"
      ...
      <div className="w-11/12 mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg  text-base-content max-w-3xl mx-auto">
            Discover the insurance plans our customers trust the most. These
            top-rated policies offer the perfect balance of coverage and value.
          </p>
        </div>
            ...
            <motion.div
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className=" bg-base-300 text-blue-800 text-xs font-semibold px-2 py-1 rounded">
                    #{index + 1}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-xs  text-base-content">Coverage</div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-xs  text-base-content">Term</div>
                      <div className="font-bold  text-base-content">
                        {policy.term}
                      </div>
                    </div>
                ...
                <div className="flex justify-between items-center mt-6 pt-6 border-t border-gray-100">
                  ...
                  <motion.a
                    ...
                    className="flex items-center bg-gradient-to-r from-blue-600 to-purple-600  text-base-content px-4 py-2 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all group"
