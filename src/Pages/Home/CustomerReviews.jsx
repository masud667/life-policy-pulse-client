...
const CustomerReviews = () => {
 ...
 const  [reviews, setReviews ] = useState([])
  ...
  // Sample review data
useEffect(() => {
    axios.get("https://life-policy-pulse-server.vercel.app/testimonials") 
    ...
    <div className="py-12">
      ...
      <div className="relative">
        ...
        >
          {reviews.map((review) => (
            <SwiperSlide key={review.id}>
              <div className="bg-white rounded-xl shadow-lg p-6 h-full flex flex-col transition-all duration-300 hover:shadow-xl">
                ...
                <div className="text-right flex justify-between">
                 <h3 className="font-bold text-gray-800">{review.policyName}</h3>
        ...
        <div className="flex items-center justify-center mt-8 space-x-4">
          <button className="custom-prev bg-white rounded-full p-2 shadow-md hover:bg-indigo-50 transition-colors">
          ...
          <button className="custom-next bg-white rounded-full p-2 shadow-md hover:bg-indigo-50 transition-colors">
