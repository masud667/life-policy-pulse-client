      ...
      <div className="min-h-screen  bg-base-100 flex items-center justify-center py-12">
        <div className="w-11/12  text-center">
          ...
          <motion.div
            ...
            <motion.p
              className="text-xl  text-base-content max-w-2xl mx-auto mb-10"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.div
              ...
              <Link
                to="/"
                className="inline-block bg-gradient-to-r from-blue-600 to-purple-600  text-base-content font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                Return to Safety
              </Link>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            className="mt-20 mx-auto max-w-xs  bg-base-100 p-6 rounded-xl shadow-lg border border-purple-100"
            animate={{
              y: [0, -15, 0],
              rotate: [0, 2, -2, 0],
            }}
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <div className="h-3  bg-base-200 rounded-full w-24"></div>
              </div>
            </div>
