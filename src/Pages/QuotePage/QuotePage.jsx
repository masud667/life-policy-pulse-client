        ...
        <div className="w-11/12 mx-auto py-32">
          <div className="text-center mb-10">
            ...
            <motion.p
              ...
              Get an instant estimate of your life insurance premium. Our
              algorithm considers your unique profile to provide the most
              accurate quote.
            </motion.p>
          </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        type="button"
                        onClick={() =>
                          setQuoteData((prev) => ({ ...prev, gender: "male" }))
                        }
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        type="button"
                        onClick={() =>
                          setQuoteData((prev) => ({ ...prev, smoker: "no" }))
                        }
                        className={`py-3 px-4 rounded-lg text-center font-medium border ${
                          quoteData.smoker === "no"
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setQuoteData((prev) => ({ ...prev, smoker: "yes" }))
                        }
                        className={`py-3 px-4 rounded-lg text-center font-medium border ${
                ...
                {estimatedPremium ? (
                  <div className="space-y-6">
                    <div className=" bg-base-100/10 rounded-2xl p-6 text-center">
                      ...
                      <p className="text-blue-200">
                        That's just ৳
                        {(estimatedPremium.monthly / 30).toFixed(0)} per day
                      </p>
                    </div>
                    ...
                    <div className=" bg-base-100/10 rounded-2xl p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            ৳{estimatedPremium.yearly}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-blue-100">
                            Total for {quoteData.duration} years
                          </span>
                          <span className="font-medium">
                            ৳
                            {estimatedPremium.yearly *
                              parseInt(quoteData.duration)}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className=" bg-base-100/10 rounded-2xl p-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            ৳
                            {new Intl.NumberFormat().format(quoteData.coverage)}
                          </span>
                        </div>
                        <div className="flex justify-between">
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-blue-200 max-w-md mx-auto">
                      Complete the form to see your personalized life insurance
                      premium estimate. It only takes 60 seconds!
                    </p>
                  </div>
                )}
              </div>
              ...
              {[
                {
                  ...
                  answer:
                    "Our quote estimates are 95% accurate based on industry standards. Your final premium may vary slightly after medical underwriting.",
                },
                {
                  question: "What factors affect my premium?",
                  answer:
                    "Premiums are based on age, gender, health, coverage amount, policy term, and lifestyle factors like smoking.",
                },
                {
                  question: "Can I change my coverage later?",
                  answer:
                    "Yes, you can increase your coverage during annual reviews or after qualifying life events like marriage or having a child.",
                },
                {
                  question: "How long does approval take?",
                  answer:
                    "Most applicants receive approval within 24-48 hours. Some cases requiring additional medical information may take 5-7 business days.",
                },
              ].map((faq, index) => (
                <motion.div
                  key={index}
